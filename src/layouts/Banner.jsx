  ...
  return (
    <div className='bg-banner bg-no-repeat bg-center bg-cover w-full '>
        <div className='bg-[#6b62c5e6] pt-[200px] pb-[100px] md:pt-[265px] md:pb-[265px] w-full h-full '>
            <Container>
                <h1 className='text-[26px] px-2 w-auto md:px-0 md:w-[1070px] text-center mx-auto md:text-[84px] text-[#FAFAFE] font-bold font-open'>yOU’RE UNIQUE.YOUR WEBSITE SHOULD BE TOO</h1>
